...
$(document).ready(function () {
    ...
    tinyMceDeluxe.init(['pagebreak', 'paste', 'table', 'template', 'syntaxhl'], {
		...
		language: "ru",
        plugins: "fullscreen,autoresize,searchreplace,mediapicker,wordpicker,inlinepopups,-table,-pagebreak,-template,-paste,-syntaxhl",
        theme_advanced_toolbar_location: "top",
        theme_advanced_toolbar_align: "left",
        theme_advanced_statusbar_location: "bottom",
        theme_advanced_resizing: "true",
        theme_advanced_buttons1: "search,replace,|,cut,copy,paste,|,undo,redo,|,link,unlink,charmap,emoticon,codeblock,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,fontselect,fontsizeselect,|,code,fullscreen",
        theme_advanced_buttons2: "mediapicker,wordpicker,|,tablecontrols,|,hr,removeformat,visualaid,|,visualchars,template,blockquote,pagebreak",
        ...
        content_css: '/Themes/Contoso/Styles/Site.css',
        valid_elements: "*[*]",
